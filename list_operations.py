...
def first_three(input_list):
    ...
    """
    zero_through_three = input_list[0:3]
    return zero_through_three
...
def inner_four(input_list):
    ...
    """
    inner_four_el = input_list[2:6]
    return inner_four_el
...
def inner_four_end(input_list):
    ...
    """
    inner_four_end_el = input_list[-6:-2]
    return inner_four_end_el
